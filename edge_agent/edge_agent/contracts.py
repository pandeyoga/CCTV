"""Edge<->backend contract — the SSOT (AGENTS.md). backend/app/contracts.py must stay identical.

Schemas in /contracts are generated by scripts/export_event_schema.py and drift-tested on both sides (ADR-002).
"""
