"""Single source of truth for the edge -> backend event contract (schema v1).

The committed JSON schema at /contracts/event_v1.schema.json is generated from
these models; tests fail if they drift. The backend must import/replicate this
exact shape. Identity fields (tenant_id, store_id, device_id) are deliberately
NOT part of the payload: the server derives them from device authentication.
"""
