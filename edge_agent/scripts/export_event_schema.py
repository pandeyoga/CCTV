...
from edge_agent.contracts import device_config_json_schema, event_batch_json_schema, heartbeat_json_schema, zone_sample_json_schema  # noqa: E402
...
for name, schema in (("event_v1.schema.json", event_batch_json_schema()), ("heartbeat_v1.schema.json", heartbeat_json_schema()),
                     ("zone_sample_v1.schema.json", zone_sample_json_schema()), ("device_config_v1.schema.json", device_config_json_schema())):
